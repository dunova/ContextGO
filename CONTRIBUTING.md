...
- 安装态 smoke/benchmark 是健康阈值：`scripts/context_smoke.py` 和 `scripts/smoke_installed_runtime.py` 覆盖本地与已安装环境的 `context_cli`、`health`、`quality gate`、导出/导入/serve`，确保默认路径在 smoke 下可用。  
